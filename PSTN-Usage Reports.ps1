...
else 
    {
        ...
        foreach ($PSTNUsage in $PSTNUSAGEs)
            {       
                ...
                $detail | add-Member -MemberType NoteProperty -Name "Usage" -Value $PSTNUSAGE.Usage
            }
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQNtzycw0Osd0SlyHpwq6f0g3
# 3vSgghIHMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# FgQUcsYD7Ol983QMcpSSLGQfwnTaeI4wDQYJKoZIhvcNAQEBBQAEggIAICRqPRc6
# 66/79cXsmp9sHroJjVGywwGsJENW8Z2tKCM5Wh0jX9DEIsfgn+4A/k9Km2uKpErr
# Zvny1mQ4Y57pG3AJu5D2jM9Q/cajQ6WGe7BPtLRy33dUmG9hp35K277ZL0LwSWX3
# 4UmsmaElsYnsLTrS5DXvR3Hn8bICrrTApgDxIwHHuRRM+XdkoUCJSLyfTXtu94cz
# 1BCxx/uDdEo4KfENDh1J7PSvFhVUgay8bQN5OWJKRcTInRvgMDwll85wkjOJ4EHc
# xuRn0Q1EdwQePBqaflrvRgKqnEF3ofZkNExI2WL28f2jUw0SGHqpNo+t/Ekkypfs
# 1u65NW4GtHvLlbENpASfTZ1TkmVwrDdghPIF4kYjzACGFPEILfSe4lKfo5q3JHwC
# lmtQTZ4tQfEPpd8Pmyz4b9lBcruR9wiEi8BX5uOnNrZ3ypJcW81pfwUQxRmKPCa1
# 8HDnSYy1SO24NIcv9jzkyLWry5Id+TqBNl6aBGHcfO1Q/JMiDHC2Mriz+L0UXvwF
# CkYHxKloyR2d/Qd63W/Q+9DtYcHfDFSSkVjUUUDQnHY3sbAFsg9rmmg5VQ+ePvjy
# Dyvxqjm8ADF3tD9WjNaLfOFnonvODCtviheO1DlqB2nLE3LGZmDqT0cDP1+mnq6Y
# MKcJABhmAzsoNaL7d9yljpptBJTFN+M9LWU=
